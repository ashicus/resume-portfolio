<? require($basePath . "/includes/skills.php") ?>
<? require($basePath . "/includes/projects.php") ?>
<!DOCTYPE html>
...
<head>
	...
	<link rel="stylesheet" href="<?= $basePath ?>/css/style.css" type="text/css" media="screen, print" />
	<link rel="stylesheet" href="<?= $basePath ?>/css/print.css" type="text/css" media="<?= @$_GET['media'] == 'print' ? 'screen, ' :'' ?>print" />
...
<body>
	<div id="container">
		<section id="about">
			<header>
				<p class="photo">
					<img src="<?= $basePath ?>/images/ash_white.jpg" alt="Ash M. White" />
				</p>

				<h1><a href="<?= $basePath ?>">Ash M. White</a></h1>
